...
// kind.
func (srv *KafkaServer) Handle(reqKind int16, handler RequestHandler) {
	srv.mu.Lock()
	srv.handlers[reqKind] = handler
	srv.mu.Unlock()
}

func (srv *KafkaServer) Address() string {
	return srv.ln.Addr().String()
}

func (srv *KafkaServer) HostPort() (string, int) {
...
func (srv *KafkaServer) defaultRequestHandler(request Serializable) Serializable {
	srv.mu.RLock()
